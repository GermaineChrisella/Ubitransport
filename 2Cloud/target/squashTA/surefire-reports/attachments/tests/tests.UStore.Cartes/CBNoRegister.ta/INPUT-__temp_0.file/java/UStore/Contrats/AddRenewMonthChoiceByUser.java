...
import java.util.Map;
  ...
  public class AddRenewMonthChoiceByUser {
  ...
  @Test
  public void testAddRenewMonthChoiceByUser() throws Exception {
    driver.get(baseUrl);
  ...
  // driver.findElement(By.cssSelector("div > div.right-main-product > div:nth-child(4) > div:nth-child(6) > div > div.single-product-text > div.product-price")).click();
   ...
   // System.out.println(vars.get("montant").toString());
    ...
    driver.findElement(By.cssSelector(".right-main-product >div:nth-child(4)>div:nth-child(2) > .single-product-item> .single-product-text> .product-price")).click();
    ...
    Thread.sleep((3000));
    {
     WebElement element = driver.findElement(By.cssSelector(".right-main-product >div:nth-child(4)>div:nth-child(2) > .single-product-item"));
    ...
    {
      WebElement element = driver.findElement(By.cssSelector(".right-main-product >div:nth-child(4)>div:nth-child(2) > .single-product-item> .single-product-text .pro-add-to-cart:nth-child(2)"));
      Actions builder = new Actions(driver);
      builder.moveToElement(element).perform();
    }
    System.out.println(3);
    {
     ...
     wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".right-main-product >div:nth-child(4)>div:nth-child(2) > .single-product-item> .single-product-text .pro-add-to-cart:nth-child(2) .pull-left>a")));
    }
    System.out.println(4);
    driver.findElement(By.cssSelector(".right-main-product >div:nth-child(4)>div:nth-child(2) > .single-product-item> .single-product-text .pro-add-to-cart:nth-child(2) .pull-left>a")).click();
