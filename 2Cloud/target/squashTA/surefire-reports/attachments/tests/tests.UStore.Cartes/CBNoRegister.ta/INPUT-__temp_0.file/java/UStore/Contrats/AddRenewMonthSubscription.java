...
import java.util.Map;
  ...
  public class AddRenewMonthSubscription {
  ...
  @Test
  public void testAddRenewMonthSubscription() throws Exception {
    driver.get(baseUrl);
   ...
   Thread.sleep((3000));
    ...
    System.out.println(3);
    {
     ...
     wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".right-main-product >div:last-child>div:last-child > .single-product-item> .single-product-text .pro-add-to-cart:nth-child(2) .pull-left>a")));
    }
    System.out.println(4);
    driver.findElement(By.cssSelector(".right-main-product >div:last-child>div:last-child > .single-product-item> .single-product-text .pro-add-to-cart:nth-child(2) .pull-left>a")).click();
