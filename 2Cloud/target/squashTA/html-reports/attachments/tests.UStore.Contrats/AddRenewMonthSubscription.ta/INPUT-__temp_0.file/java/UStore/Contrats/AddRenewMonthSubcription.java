...
import java.util.Map;
  ...
  public void testAddRenewMonthSubscription() throws Exception {
    ...
    {
      WebElement element = driver.findElement(By.cssSelector(".pro-add-to-cart:nth-child(4)"));
      Actions builder = new Actions(driver);
      builder.moveToElement(element).perform();
    }
    {
      WebDriverWait wait = new WebDriverWait(driver, 30);
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".pro-add-to-cart:nth-child(4)>p>a")));
    }
    driver.findElement(By.cssSelector(".pro-add-to-cart:nth-child(4)>p>a")).click();
