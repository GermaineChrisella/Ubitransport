...
import java.util.Map;
  ...
  public void testBoutiqueConnexion() throws Exception {
	...
	//driver.findElement(By.cssSelector(".header-right-menu > nav > ul > li:nth-child(2) > a")).click();
	 driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Rechargez votre carte avec des abonnements et des titres de transport'])[1]/following::button[1]")).click();
